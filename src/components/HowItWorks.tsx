...
const steps = [
  {
    ...
    step: '01',
    title: 'Diagnóstico',
    description: 'Análise personalizada do seu negócio e identificação de oportunidades'
  },
  {
    icon: Settings,
    step: '02',
    title: 'Implementação',
    description: 'Configuração completa de automação e integração com suas ferramentas'
  },
  {
    icon: TrendingUp,
    step: '03',
    title: 'Escala e Otimização',
    description: 'Monitoramento, otimização e crescimento contínuo dos resultados'
  }
];

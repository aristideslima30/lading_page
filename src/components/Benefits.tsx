...
const benefits = [
  {
    ...
    description: 'Estratégias comprovadas que transformam visitantes em clientes pagantes'
  },
  {
    icon: Clock,
  ...
  {
    icon: Bot,
    title: 'Nutrição de Leads Automatizada',
    description: 'Relacionamento inteligente que educa e converte automaticamente'
  },
  {
    icon: MessageSquare,
    title: 'Integração Total',
    description: 'WhatsApp, e-mail, CRM e todas suas ferramentas conectadas'
  }
];

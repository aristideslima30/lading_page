...
const services = [
  {
    ...
    description: 'Fluxos inteligentes que nutrem leads e convertem automaticamente'
  },
  {
    icon: Target,
    title: 'Funis de Vendas',
    description: 'Jornadas otimizadas que guiam clientes do interesse à compra'
  },
  {
    icon: MessageCircle,
    title: 'Integração WhatsApp',
    description: 'Chatbots e automações que vendem 24/7 pelo WhatsApp'
  },
  {
    icon: Database,
    title: 'CRM Inteligente',
    description: 'Gestão completa de relacionamento com scoring automático'
  },
  {
    icon: BarChart3,
    title: 'Gestão de Campanhas',
    description: 'Otimização contínua com dados e inteligência artificial'
  }
];
